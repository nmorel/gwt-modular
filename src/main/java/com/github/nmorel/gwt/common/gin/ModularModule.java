...
import com.github.nmorel.gwt.common.mvp.AppActivityMapper;
import com.github.nmorel.gwt.common.mvp.AppPlaceHistoryMapper;
import com.github.nmorel.gwt.common.views.layout.AppLayout;
import com.github.nmorel.gwt.home.HomePlace;
...
public class ModularModule extends AbstractGinModule {
    ...
    @Singleton
    @Named("container")
    public AcceptsOneWidget providesContainer(AppLayout appLayout) {
